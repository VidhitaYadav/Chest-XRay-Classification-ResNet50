...
2. Image Preprocessing (Resize, Normalize, Augmentation)  
3. ResNet50 Backbone (Pretrained)  
4. Global Average Pooling  
5. Batch Normalization  
6. Dense Layer (256 neurons)  
7. Dropout Layer  
8. Output Layer (Softmax – 7 classes)  
